#!/usr/bin/env python3
"""
Setup users_auth table in Supabase PostgreSQL
"""
import os
import sys
...
print("=" * 80)
print("\n✅ INSTRUCTIONS:")
print("1. Open: https://supabase.com/dashboard/project/hhaduosajnvamyxrqzwd/sql/new")
print("2. Paste the SQL script above")
print("3. Click 'Run' button")
print("4. Verify the results show 5 users created")
