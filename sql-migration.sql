...
INSERT INTO services (service_code, name, description, price) VALUES
  ('SV01', 'เปลี่ยนน้ำมันเครื่อง (Small Cars)', 'พร้อมผลิตธิ์ดำเนินการยนต์ FULLY SYNTHETIC', 2200),
  ('SV02', 'เปลี่ยนน้ำมันเครื่อง (Mid Cars)', 'พร้อมผลิตธิ์ดำเนินการยนต์ FULLY SYNTHETIC', 2500),
  ('SV03', 'เปลี่ยนน้ำมันเครื่อง (SUV/PPV)', 'พร้อมผลิตธิ์ดำเนินการยนต์ FULLY SYNTHETIC', 3000),
  ('SV04', 'เปลี่ยนน้ำมันเครื่อง (ยุโรป)', 'พร้อมผลิตธิ์ดำเนินการยนต์ FULLY SYNTHETIC', 4500),
  ('SV05', 'เปลี่ยนน้ำมันเครื่อง (ซุปเปอร์คาร์)', 'พร้อมผลิตธิ์ดำเนินการยนต์ FULLY SYNTHETIC', 6500),
  ('SV06', 'ฟลัชชิ่งเกียร์ AT, DCT, DSG', 'ระบบดูดสุญญากาศ ไม่ต้องถอดอ่าง', 4800),
  ('SV07', 'เปิดอ่างเกียร์ + ล้างสมองเกียร์', 'พร้อมน้ำคลิมบิ้งสำสองเบรค', 1500),
  ('SV08', 'เปลี่ยนน้ำมันเฟืองท้าย (RWD/AWD/4WD)', 'สำหรับ RWD / AWD / 4WD', 2400),
  ('SV09', 'เปลี่ยนน้ำมันเบรก', 'รวมค่าแรงและน้ำมัน', 2000),
  ('SV10', 'เปลี่ยนน้ำยาหล่อเย็น (Coolant)', 'ล้างระบบ + เติมใหม่', 2100),
  ('SV11', 'Hybrid Service (1 ระบบ)', 'บริการสำหรับรถ Hybrid พร้อมเปิดอ่าง', 4000),
  ('SV12', 'Hybrid Service (2 ระบบ)', 'บริการ Hybrid ครบสูตร พร้อมล้างสมองเกียร์', 5500),
  ('SV13', 'ตรวจเช็คช่วงล่าง', 'ด้วยเครื่องจำลองถนนจริง', 0),
  ('SV14', 'ค่าแรง / ค่าบริการทั่วไป', '', 0),
  ('SV15', 'ฟลัชชิ่ง (Flushing)', 'Premium Flushing additive', 590)
